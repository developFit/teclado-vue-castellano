module.exports = {
	...
	"compact": {
		...
		_meta: {
			...
			"accept": { func: "accept", text: "Cerrar", classes: "control featured"},
			"next": { func: "next", text: "Seguir", classes: "featured"},
